...
class DialogHelper {
  ...
  static Future<void> showAlert(BuildContext context, String message) {
    return showDialog<String>(
      context: context,
      barrierColor: blueAccentShade40,
      barrierDismissible: false,
      builder: (BuildContext context) => AlertDialog(
        content: Text(message),
        actionsPadding: const EdgeInsets.only(right: 20, top: 20, bottom: 15),
  ...
  static Future<bool?> showConversation(BuildContext context, String message) {
    return showDialog<bool?>(
      ...
      builder: (BuildContext context) => AlertDialog(
        ...
        actionsPadding: const EdgeInsets.only(left: 20, right: 20, top: 30, bottom: 15),
        contentPadding: const EdgeInsets.only(left: 20, right: 20, top: 20),
        insetPadding: const EdgeInsets.symmetric(horizontal: 20),
        elevation: 4,
